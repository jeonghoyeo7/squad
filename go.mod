module github.com/cosmosquad-labs/squad/v3
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/cosmosquad-labs/cosmos-sdk v1.1.2-sdk-0.45.9
	github.com/cosmos/ibc-go/v2 => github.com/cosmosquad-labs/ibc-go/v2 v2.2.0-squad-v3
