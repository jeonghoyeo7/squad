...
++https://github.com/cosmosquad-labs/squad/blob/main/proto/squad/lpfarm/v1beta1/query.proto
...
```bash
http://localhost:1317/squad/lpfarm/v1beta1/params
```
...
```bash
http://localhost:1317/squad/lpfarm/v1beta1/plans
```
...
```bash
http://localhost:1317/squad/lpfarm/v1beta1/plans/1
```
...
```bash
http://localhost:1317/squad/lpfarm/v1beta1/farms/pool1
```
...
```bash
http://localhost:1317/squad/lpfarm/v1beta1/positions/cosmos1zaavvzxez0elundtn32qnk9lkm8kmcszzsv80v
```
...
```bash
http://localhost:1317/squad/lpfarm/v1beta1/positions/cosmos1zaavvzxez0elundtn32qnk9lkm8kmcszzsv80v/pool1
```
...
```bash
http://localhost:1317/squad/lpfarm/v1beta1/historical_rewards/pool1
```
...
```bash
http://localhost:1317/squad/lpfarm/v1beta1/rewards/cosmos1zaavvzxez0elundtn32qnk9lkm8kmcszzsv80v
```
...
```bash
http://localhost:1317/squad/lpfarm/v1beta1/rewards/cosmos1zaavvzxez0elundtn32qnk9lkm8kmcszzsv80v/pool1
```
