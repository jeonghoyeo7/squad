...
```bash
http://localhost:1317/squad/farm/v1beta1/positions/cosmos1mzgucqnfr2l8cj5apvdpllhzt4zeuh2cshz5xu
```
...
```bash
http://localhost:1317/squad/farm/v1beta1/positions/cosmos1mzgucqnfr2l8cj5apvdpllhzt4zeuh2cshz5xu/pool1
```
...
```bash
http://localhost:1317/squad/farm/v1beta1/rewards/cosmos1mzgucqnfr2l8cj5apvdpllhzt4zeuh2cshz5xu
```
...
```bash
http://localhost:1317/squad/farm/v1beta1/rewards/cosmos1mzgucqnfr2l8cj5apvdpllhzt4zeuh2cshz5xu/pool1
```
