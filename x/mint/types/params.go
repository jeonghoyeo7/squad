...
var (
	...
	// CustomMintPoolAddress is customized mint pool, If the fee collector as default mint pool is used,
	...
	CustomMintPoolAddress = authtypes.NewModuleAddress(authtypes.FeeCollectorName)
