...
func (s *keysTestSuite) TestGetLiquidFarmKey() {
	s.Require().Equal([]byte{0xe4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}, types.GetLiquidFarmKey(0))
	s.Require().Equal([]byte{0xe4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x9}, types.GetLiquidFarmKey(9))
	s.Require().Equal([]byte{0xe4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa}, types.GetLiquidFarmKey(10))
}

func (s *keysTestSuite) TestGetCompundingRewardsKey() {
	s.Require().Equal([]byte{0xe7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}, types.GetCompoundingRewardsKey(0))
	s.Require().Equal([]byte{0xe7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x9}, types.GetCompoundingRewardsKey(9))
	s.Require().Equal([]byte{0xe7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa}, types.GetCompoundingRewardsKey(10))
}
...
func (s *keysTestSuite) TestGetRewardsAuctionKey() {
	testCases := []struct {
	...
	}{
		{
			1,
			1,
			[]byte{0xe8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
