...
func (s *keysTestSuite) TestGetCompundingRewardsKey() {
	s.Require().Equal([]byte{0xe6, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}, types.GetCompoundingRewardsKey(0))
	s.Require().Equal([]byte{0xe6, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x9}, types.GetCompoundingRewardsKey(9))
	s.Require().Equal([]byte{0xe6, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa}, types.GetCompoundingRewardsKey(10))
}
